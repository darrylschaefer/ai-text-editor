...
import { ChatInterface, ConfigInterface, MessageCurrent, MessageInterface, ModelOptions } from '@type/chat';
...
export const generateDefaultMessage = (config?: ConfigInterface, chatMessages?: MessageInterface[]): MessageCurrent => {
...
export const generateWelcomeChat = ({title, folder, prompt}: {title?: string, folder?: string, prompt?: string}): ChatInterface => ({
  id: uuidv4(),
...
export const generateDefaultChat = ({title, folder, prompt}: {title?: string, folder?: string, prompt?: string}): ChatInterface => ({
  id: uuidv4(),
